...
class SimulationEngineTest {
    ...
    private static CarSpec car(String name, int x, int y, String direction, String commands) {
    ...
    private SimulationResult run(Simulation simulation) {
        return engine.run(simulation);
    }
    ...
    class Scenarios {
        ...
        void scenario1SingleCarEndsAt54FacingSouth() {
            SimulationResult result = run(simulation(10, 10, car("A", 1, 2, "N", "FFRFFFFRRL")));
        ...
        void scenario2CarsCollideAt54AtStep7() {
            SimulationResult result = run(simulation(10, 10,
    ...
    class Movement {
        ...
        void moveBeyondBoundaryIsIgnoredAndLaterCommandsStillApply() {
            SimulationResult result = run(simulation(10, 10, car("A", 0, 0, "S", "FLF")));
        ...
        void carStaysInTopRightCornerWhenDrivingIntoBoundary() {
            SimulationResult result = run(simulation(10, 10, car("A", 9, 9, "N", "FFRFF")));
        ...
        void oneByOneFieldAllowsOnlyRotation() {
            SimulationResult result = run(simulation(1, 1, car("A", 0, 0, "N", "FRFRFRF")));
    ...
    class ParkedCars {
        ...
        void onlyParkedCarsProduceNoMovement() {
            SimulationResult result = run(simulation(10, 10, car("P", 4, 4, "E", "")));
    ...
    class Collisions {
        ...
        void carsBlockedByBoundaryDoNotSwap() {
            SimulationResult result = run(simulation(2, 1,
                    car("A", 0, 0, "W", "F"),
                    car("B", 1, 0, "E", "F")));
    ...
    void runningTwiceGivesTheSameResultAndDoesNotModifyTheSimulation() {
        Simulation simulation = simulation(10, 10,
                car("A", 1, 2, "N", "FFRFFFFRRL"),
                car("B", 7, 8, "W", "FFLFFFFFFF"));
        List<CarSpec> before = simulation.cars();

        SimulationResult first = run(simulation);
        SimulationResult second = run(simulation);
